...
pub fn create_router(s: AppState) -> Router {
    ...
    let all_routes = Router::new()
        ...
        .route("/directories/:slug/loyalty/programs/:program_id/tiers", get(loyalty_native::list_tiers).post(loyalty_native::create_tier))
        .route("/directories/:slug/loyalty/programs/:program_id/tiers/:tier_id", delete(loyalty_native::delete_tier))
        .route("/directories/:slug/loyalty/programs/:program_id/rewards", get(loyalty_native::list_rewards).post(loyalty_native::create_reward))
        .route("/directories/:slug/loyalty/programs/:program_id/rewards/:reward_id", delete(loyalty_native::delete_reward))
        .route("/directories/:slug/loyalty/programs/:program_id/rewards/earn", post(loyalty_native::earn_reward))
