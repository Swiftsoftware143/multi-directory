...
pub fn create_router(s: AppState) -> Router {
    ...
    let all_routes = Router::new()
        ...
        .route("/zaarhub/categories", get(zaarhub::list_categories))
        ...
        // ??? ZaarHub SEO (sitemap_xml generated from city_pages table)
        .route("/zaarhub-sitemap.xml", get(zaarhub_seo::sitemap_xml))
        // ??? ZaarHub City Pages API (Phase 4 — city_pages + business_listings CRUD)
        .route("/api/v1/zaarhub/cities", get(zaarhub_cities::list_cities))
        .route("/api/v1/zaarhub/cities/:slug", get(zaarhub_cities::get_city))
        .route("/api/v1/zaarhub/cities/:slug/listings", get(zaarhub_cities::list_city_listings))
        .route("/api/v1/zaarhub/listings/:id", get(zaarhub_cities::get_listing))
        .route("/api/v1/zaarhub/categories", get(zaarhub_cities::list_categories))
        .route("/api/v1/zaarhub/search", get(zaarhub_cities::search_listings))
        .route("/api/v1/zaarhub/featured", get(zaarhub_cities::featured_listings))
        // ??? ZaarHub Claim/Redemption endpoints (public, Phase 5)
        .route("/api/v1/zaarhub/listings/:id/offers", get(zaarhub_cities::listing_offers))
        .route("/api/v1/zaarhub/offers/:id", get(zaarhub_cities::get_offer))
        .route("/api/v1/zaarhub/offers/:id/claim", post(zaarhub_cities::claim_offer))
        .route("/api/v1/zaarhub/claims/:visitor_id", get(zaarhub_cities::visitor_claims))
